...
<html class="no-js" <?php language_attributes();?> itemscope itemtype="http://schema.org/WebSite">
  ...
  <body <?php body_class();?>>
    ...
    <div class="ui-wrapper">
      ...
      <div id="az_calendar_embed"></div><script>(function(){fetch("https://azbyka.ru/days/calendar/?embed=js,styles,legend,events").then(response => response.text()).then(data => {document.getElementById("az_calendar_embed").innerHTML = data;});})();</script>
